...
public class ViewSearchFoundItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView itemsList = (ListView) findViewById(R.id.foundItemsListSearch);
        Button back = (Button) findViewById(R.id.backToHomeSearchFound);
        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, SearchFoundItemsActivity.foundSearch);
